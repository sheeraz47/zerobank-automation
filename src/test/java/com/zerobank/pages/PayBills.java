...
public class PayBills extends BasePage {
    ...
    @FindBy(css = "[title='$ 100 payed to payee apple']")
    public WebElement payemntConfirmationMessage;

    @FindBy(css = "[id='pay_bills_tab'] a")
    public WebElement clickOnPayBills;
    ...
    public WebElement decriptionElement;

    @FindBy(css = "[id='pay_saved_payees']")
